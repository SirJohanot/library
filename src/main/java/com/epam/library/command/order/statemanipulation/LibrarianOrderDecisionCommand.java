...
public class LibrarianOrderDecisionCommand implements Command {

    private final BookOrderService bookOrderService;
    private final RentalState newState;

    public LibrarianOrderDecisionCommand(BookOrderService bookOrderService, RentalState newState) {
    ...
    public CommandResult execute(HttpServletRequest req, HttpServletResponse resp) throws ServiceException {
        ...
        if (currentUser.getRole() != UserRole.LIBRARIAN) {
            throw new ServiceException("Only librarians can approve or decline placed book orders");
        }
